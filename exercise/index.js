const Person = require("./class_files/Person");
const Student = require("./class_files/Student");
const Course = require("./class_files/Course");
const School = require("./class_files/School");
